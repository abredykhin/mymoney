...
DROP POLICY IF EXISTS "Users can view their own coach insights" ON public.coach_insights;
...
DROP TRIGGER IF EXISTS coach_insights_updated_at_timestamp ON public.coach_insights;
