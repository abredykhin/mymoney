-- Fix transaction statistics functions to return double precision instead of numeric
-- This matches Swift's Double type expectations
...
-- Function to get monthly transaction stats (UPDATED - return double precision)
...
-- Function to get daily transaction stats (UPDATED - return double precision)
