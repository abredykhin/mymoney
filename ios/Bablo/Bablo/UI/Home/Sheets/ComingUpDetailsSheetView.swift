...
struct ComingUpDetailsSheetView: View {
    ...
    private var availableBalance: Double {
        let balance = accountsService.totalBalance
        return balance > 0 ? balance : 2840.0 // preview fallback
    }
    ...
    var body: some View {
        ...
        .task {
            recentPaymentDates = await subService.fetchRecentExpenseMerchantDates()
        }
    }
